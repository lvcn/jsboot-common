...
public class AesTest {
    ...
    public void aesTest() {
        ...
        aesCheck(new Aes(AesModelEnum.CBC, AesPaddingEnum.PKCS5Padding, TEST_KEY, TEST_IV),
        ...
        //AES/ECB/NoPadding
        aesCheck(new Aes(AesModelEnum.ECB, AesPaddingEnum.ZeroPadding, TEST_KEY, null),
     ...
     */
    private void aesCheck(Aes ase, String hexStr, String base64Str) {
